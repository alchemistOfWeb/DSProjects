...
struct Test8 
{
    ...
    Test8()
    {
        ...
        using namespace numbers::literals;

        // In order to understand this part read about user-defined literals.
        numbers::RationalNumber<unsigned long long> rationalNumber12 = 10_r;
        numbers::RationalNumber<unsigned long long> rationalNumber13 = 7_r / 8_r;
